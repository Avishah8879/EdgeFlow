...
(async () => {
  ...
  const { default: pairWatchlistRoutes } = await import('./routes-pair-watchlist.js');
  ...
  // Mount pair watchlist routes
  app.use('/api/saved/pair-watchlist', pairWatchlistRoutes);
