...
def generate_documentation(schema_info: Dict[str, Any], output_file: str = 'docs/auth-db-schema.txt'):
    """Generate comprehensive documentation file."""

    with open(output_file, 'w', encoding='utf-8') as f:
        # Header
        f.write("="*80 + "\n")
        f.write("TIPHUB AUTH DATABASE SCHEMA DOCUMENTATION\n")
        f.write("="*80 + "\n\n")
...
def main():
    ...
    print("\nTiphub Auth Database Schema Explorer")
    print("="*80)
    ...
    try:
        ...
        generate_documentation(schema_info, 'docs/auth-db-schema.txt')

        print("\n" + "="*80)
        print("EXPLORATION COMPLETE!")
        print("="*80)
        print(f"\nDocumentation file created: docs/auth-db-schema.txt")
